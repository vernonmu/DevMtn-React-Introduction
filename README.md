...
- .webpack.config.js
````
Why the public folder? Usually when creating a website you'll have a front-end and a back-end. It's a good idea to get into the habit of seperating the code for them to have a maintable repo. So even though there won't be a backend for this tutorial it doesn't hurt to use the same file structure.